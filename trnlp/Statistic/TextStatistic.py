...
import re
import os
from trnlp.file_processing import open_txt_file
...
# def ts_for_big_data(folder_path):
#     toplam_satir_sayisi = 0
#     toplam_bos_satir_sayisi = 0
#     bos_satir_frekansi = 0
#     toplam_yazili_satir_sayisi = 0
#     yazili_satir_frekansi = 0
#     toplam_kelime_sayisi = 0
#     tekrarsiz_kelime_sayisi = 0
#     tekrarlanan_kelime = {}
#     tekrarlanan_kelime = Counter(tekrarlanan_kelime)
#     yazidaki_karakter_sayisi = 0
#     yazidaki_bosluk_sayisi = 0
#     boslu_frekansi = 0
#     toplam_rakam_sayisi = 0
#     rakam_frekansi = 0
#     rakamlarin_listesi = 0
#     ozel_karakterlerin_sayisi = 0
#     ozel_karakter_frekans = 0
#     ozel_karakterlerin_liste = 0
#     tum_harflerin_sayisi = 0
#     tum_harflerin_frekansi = 0
#     sesli_harflerin_sayisi = 0
#     sesli_harflerin_frekansi = 0
#     sesli_harflerin_listesi = 0
#     sessiz_harflerin_sayisi = 0
#     sessiz_harflerin_frekansi = 0
#     sessiz_harflerin_listesi = 0
#     buyuk_harflerin_sayisi = 0
#     buyuk_harf_frekans = 0
#     buyukle_baslayan_sayisi = 0
#     buyukle_baslayan_frekans = 0
#     buyukle_baslayan_liste = 0
#     kucuk_harflerin_sayisi = 0
#     kucuk_harf_frekans = 0
#
...
#                     counter += 1
#                     print(counter)
#                     toplam_satir_sayisi += 1
#                     if line.strip():
#                         toplam_yazili_satir_sayisi += 1
#                     else:
#                         toplam_bos_satir_sayisi += 1
#                         continue
#                     all_txt = list(filter(None, re.split('[^A-Za-zçÇğĞıİöÖşŞüÜâÂêÊîÎôÔûÛ]', line)))
#                     toplam_kelime_sayisi += len(all_txt)
#                     tekrarlanan_kelime = tekrarlanan_kelime + Counter(all_txt)
#                     all_txt = ''
#                     yazidaki_karakter_sayisi += len(line)
#     tekrarlanan_kelime = sorted(dict(tekrarlanan_kelime).items(), key=itemgetter(1), reverse=True)
#     tekrarlanan_kelime = tekrarlanan_kelime[:10]
#
#     istatistik = """
# Yazının İstatistiksel Bilgileri :
# ------------------------------------------
...
# Toplam Kelime Sayısı ....................: {5}
# Tekrarsız Kelime Sayısı..................: {6}
# En Çok Tekrarlanan ilk 10 Kelime ........: {7}
# ------------------------------------------
# Tüm Karakterin Sayısı ...................: {8}
# Boşluk Karakteri Sayısı .................: {9} / frq : %{10} (Tüm Karakterin Sayısına Göre)
# Toplam Rakam Sayısı .....................: {11} / frq : %{12} (Tüm Karakterin Sayısına Göre)
...
#                    buyukle_baslayan_frekans, buyukle_baslayan_liste, kucuk_harflerin_sayisi, kucuk_harf_frekans)
#
# ts_for_big_data('C:/Users/bilgisayar/PycharmProjects/NLP/Yedek/Birlestirilmis_txt')
